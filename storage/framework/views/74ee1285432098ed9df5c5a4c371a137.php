...
<div class="flex flex-col lg:flex-row gap-8">
    ...
    <div class="flex-1 min-w-0">
        ...
        <div class="mb-6">
            <h1 class="text-2xl font-heading font-bold text-[#132129] dark:text-[#e8eef1] mb-4"><?php echo e($question->title); ?></h1>

            <div class="flex flex-wrap items-center gap-3 mb-4 text-sm text-[#5a656b] dark:text-[#8a959b]">
                <span class="flex items-center gap-1">
                    <span class="font-medium text-[#0b1418] dark:text-[#e8eef1]"><?php echo e($question->votes_count); ?></span> <?php echo e(Str::plural('vote', $question->votes_count)); ?>

                </span>
                <span><?php echo e($question->answers_count); ?> <?php echo e(Str::plural('answer', $question->answers_count)); ?></span>
                <span><?php echo e($question->view_count); ?> <?php echo e(Str::plural('view', $question->view_count)); ?></span>
                <span>asked <?php echo e($question->created_at->diffForHumans()); ?></span>
            </div>
            ...
            <div class="flex gap-4">
                ...
                <div class="flex flex-col items-center gap-0.5 shrink-0">
                    ...
                    <button onclick="handleVote('App\\Models\\Question', <?php echo e($question->id); ?>, 1, this.closest('.flex.flex-col'))"
                    ...
                    <span class="text-lg font-bold tabular-nums text-[#5a656b] dark:text-[#8a959b]" data-votes-count><?php echo e($question->votes_count); ?></span>
                    <button onclick="handleVote('App\\Models\\Question', <?php echo e($question->id); ?>, -1, this.closest('.flex.flex-col'))"
                    ...
                    <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="p-1 rounded text-[#5a656b] dark:text-[#8a959b]" title="Log in to vote">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7"/></svg>
                    </a>
                    <span class="text-lg font-bold tabular-nums text-[#5a656b] dark:text-[#8a959b]"><?php echo e($question->votes_count); ?></span>
                    <?php endif; ?>
                </div>
                ...
                <div class="flex-1 min-w-0">
                    <div class="prose dark:prose-invert prose-sm max-w-none text-[#0b1418] dark:text-[#e8eef1] mb-4">
                        ...
                        <div class="whitespace-pre-wrap break-words"><?php echo e($question->body); ?></div>
                    </div>
                    ...
                    <div class="flex flex-wrap items-center justify-between gap-2 pt-3 border-t border-[#d9dfe2] dark:border-[#2a353a]">
                        <div class="flex items-center gap-2 text-sm">
                            <a href="<?php echo e(route('users.profile', $question->user)); ?>" class="flex items-center gap-2">
                                <div class="w-8 h-8 rounded-full bg-[#009494] flex items-center justify-center text-white text-xs font-bold"><?php echo e(strtoupper(substr($question->user->name, 0, 1))); ?></div>
                                <span class="font-medium text-[#009494] hover:underline"><?php echo e($question->user->name); ?></span>
                            </a>
                            <span class="text-[#5a656b] dark:text-[#8a959b]">asked <?php echo e($question->created_at->format('M j, Y')); ?></span>
                        </div>

                        <div class="flex items-center gap-2">
                            <?php if(auth()->guard()->check()): ?>
                            <?php if(auth()->id() === $question->user_id || auth()->user()->isModerator()): ?>
                                
                            <?php endif; ?>
                            <button onclick="flagContent('App\\Models\\Question', <?php echo e($question->id); ?>)"
        ...
        <div class="mt-8">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $question->answers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $answer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="mb-4 bg-[#fdffff] dark:bg-[#132129] rounded-lg border <?php echo e($answer->is_accepted ? 'border-[#009494] ring-1 ring-[#009494]/20' : 'border-[#d9dfe2] dark:border-[#2a353a]'); ?> p-5">
                    ...
                    <div class="flex gap-4">
                        ...
                        <div class="flex flex-col items-center gap-0.5 shrink-0">
                            <?php if(auth()->guard()->check()): ?>
                            <button onclick="handleVote('App\\Models\\Answer', <?php echo e($answer->id); ?>, 1, this.closest('.flex.flex-col'))"
                                    class="p-1 rounded hover:bg-[#e8eef1] dark:hover:bg-[#1a282f] text-[#5a656b] dark:text-[#8a959b] hover:text-[#009494] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#009494]"
                                    aria-label="Upvote answer">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7"/></svg>
                            </button>
                            <span class="text-base font-bold tabular-nums text-[#5a656b] dark:text-[#8a959b]" data-votes-count><?php echo e($answer->votes_count); ?></span>
                            <button onclick="handleVote('App\\Models\\Answer', <?php echo e($answer->id); ?>, -1, this.closest('.flex.flex-col'))"
                                    class="p-1 rounded hover:bg-[#e8eef1] dark:hover:bg-[#1a282f] text-[#5a656b] dark:text-[#8a959b] hover:text-[#c9302d] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#c9302d]"
                            ...
                            <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="p-1 rounded text-[#5a656b] dark:text-[#8a959b]">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7"/></svg>
                            </a>
                            <span class="text-base font-bold tabular-nums text-[#5a656b] dark:text-[#8a959b]"><?php echo e($answer->votes_count); ?></span>
                            <?php endif; ?>

                            
                            <?php if(auth()->guard()->check()): ?>
                            <?php if(auth()->id() === $question->user_id && !$answer->is_accepted && !$question->accepted_answer_id): ?>
                                <button onclick="acceptAnswer('<?php echo e($question->slug); ?>', <?php echo e($answer->id); ?>)"
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="whitespace-pre-wrap break-words text-[#0b1418] dark:text-[#e8eef1] text-sm mb-3"><?php echo e($answer->body); ?></div>
                            <div class="flex items-center justify-between pt-2 border-t border-[#d9dfe2] dark:border-[#2a353a]">
                                <div class="flex items-center gap-2 text-xs">
                                    <a href="<?php echo e(route('users.profile', $answer->user)); ?>" class="flex items-center gap-1.5">
                                        <div class="w-6 h-6 rounded-full bg-[#5a656b] flex items-center justify-center text-white text-[10px] font-bold"><?php echo e(strtoupper(substr($answer->user->name, 0, 1))); ?></div>
                                        <span class="font-medium text-[#009494] hover:underline"><?php echo e($answer->user->name); ?></span>
                                    </a>
                                    <span class="text-[#5a656b] dark:text-[#8a959b]">answered <?php echo e($answer->created_at->format('M j, Y')); ?></span>
                                </div>
                                <?php if(auth()->guard()->check()): ?>
                                <button onclick="flagContent('App\\Models\\Answer', <?php echo e($answer->id); ?>)"
            ...
            <div class="mt-6 bg-[#fdffff] dark:bg-[#132129] rounded-lg border border-[#d9dfe2] dark:border-[#2a353a] p-5">
                ...
                <form method="POST" action="<?php echo e(route('answers.store', $question)); ?>" x-data="answerForm()" @submit.prevent="submit">
                    <?php echo csrf_field(); ?>
            ...
            <div class="mt-6 p-4 text-center text-sm text-[#5a656b] dark:text-[#8a959b] bg-[#e8eef1] dark:bg-[#1a282f] rounded-lg">
                <a href="<?php echo e(route('login')); ?>" class="text-[#009494] hover:underline font-medium">Log in</a> to post an answer.
            </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="w-full lg:w-[260px] shrink-0">
        <div class="bg-[#fdffff] dark:bg-[#132129] rounded-lg border border-[#d9dfe2] dark:border-[#2a353a] p-4">
            ...
            <div class="flex flex-wrap gap-2">
                <?php $__currentLoopData = $question->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('tags.show', $tag)); ?>" class="px-2.5 py-1 text-xs rounded-md border border-[#d9dfe2] dark:border-[#2a353a] text-[#5a656b] dark:text-[#8a959b] hover:text-[#009494] dark:hover:text-[#009494] hover:border-[#009494]/30 transition-colors"><?php echo e($tag->name); ?></a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
    </div>
...
function answerForm() {
    return {
        ...
        async submit() {
            ...
            try {
                const res = await fetch('<?php echo e(route('answers.store', $question)); ?>', {
                    method: 'POST',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /work/resources/views/questions/show.blade.php ENDPATH**/ ?>